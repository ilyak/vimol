...
ALL_C= atoms.c bind.c camera.c cmd.c edit.c error.c exec.c graph.c history.c \
...
ALL_O= atoms.o bind.o camera.o cmd.o edit.o error.o exec.o graph.o history.o \
